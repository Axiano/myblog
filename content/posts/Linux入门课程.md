---
title: Linux基础课程
date: 2020-05-28 16:07:15
published: true
license: true
slug: linux-jiaocheng
tags: [linux,课程]
cate: 技术
cover_image: "./images/linux.png"
canonical_url: false
description: "Linux虽然难学，但是多用用就会了"
---
# 在虚拟机中安装 Ubuntu
...
* 访问 <a href="http://cn.ubuntu.com/download/" target="_blank" style = "text-decoration:none"> Ubuntu官网 </a>下载 'Ubuntu 20.04 LTS 版本'
...
* 有了映像文件之后，只需要按照提示一步一步操作即可安装 Ubuntu 了，这个没有什么好说的，傻瓜式安装。
* 安装结束后，登录并且进入系统。
...
1. 从 <a href="https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb" target="_blank" style = "text-decoration:none"> goole浏览器</a> 下载最新版本的安装文件
2. 在终端中执行以下命令：
...
1. 打开 **系统设置** **语言支持**
    * 将 **键盘输入法系统** 修改为 **fcitx**
2. 访问网站 <a href="http://pinyin.sogou.com/linux/" target="_blank" style = "text-decoration:none"> 搜狗输入法</a>下载最新版本的安装文件
3. 在终端中执行以下命令：

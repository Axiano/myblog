<template>
  <div class="author">
    ...
    <p class="author__links">
      <g-link
        href="https://www.xiaoxiongzai.fun"
        target="_blank"
        style="color: #5c6977"
        v-tooltip="{ content: '🙋‍♂️ 主页' }"
      ...
      <g-link
        ...
        title="友链"
        style="color: #06a878"
        v-tooltip="{ content: '🍻 友链' }"
        ><font-awesome :icon="['fas', 'user-friends']" /></g-link
      ><g-link
        to="/about"
        title="关于"
        style="color: #117cb7"
        v-tooltip="{ content: '🙇‍♂️ 关于' }"
        ><font-awesome :icon="['fas', 'id-badge']"
      /></g-link>
      <g-link
        to="https://tiangou.xiaoxiongzai.fun"
        title="舔狗网"
        style="color: #774d27"
        v-tooltip="{ content: '🦴 舔狗' }"
...
<script src="~/assets/style/font//iconfont.js"></script>
<script>
export default {
  props: ["showTitle"],
};
